...
const Details = () => {
    ...
    useEffect(() => {
        const fetchTask = async () => {
            try {
                const response = await fetch(`https://taskmanager-backend-i458.onrender.com/task/${id}`);
                ...
                const assignedUserResponse = await fetch(`https://taskmanager-backend-i458.onrender.com/user?name=${data.assigned}`);
